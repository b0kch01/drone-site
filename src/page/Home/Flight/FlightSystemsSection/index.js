    ...
    <Section scrollProgress={scrollProgress}>
      <Section.Header>
        ...
        <Section.Description>
          ...
          precision and reliability for mission-critical operations in
      ...
      <Section.Subgrid>
        <Section.Subitem>
          ...
          <Section.SubitemBody>
            tracks and identifies targets in real-time with millimeter
            precision
          </Section.SubitemBody>
        </Section.Subitem>
        <Section.Subitem>
        ...
        <Section.Subitem>
          ...
          <Section.SubitemBody>
            maintains stability in 40+ knot winds with predictive
            compensation
          </Section.SubitemBody>
        </Section.Subitem>
      </Section.Subgrid>
